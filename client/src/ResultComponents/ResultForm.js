...
<div className="mb-10 md:mb-16">
  <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Submission Here</h2>

  <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg"> Submission description here</p>
</div>
...
<form onSubmit={formik.handleSubmit} className="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
  ...
  <div className="sm:col-span-2">
    <label htmlFor="placement" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">What is the Placement of this Entry?</label>
    <input type="text" name="placement" value={formik.values.placement} onChange={formik.handleChange} className="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
  </div>

  <div className="flex items-center justify-between sm:col-span-2">

    {/* NEED TO CHANGE COLOR */}
    <button type="submit" className="inline-block rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Submit Result</button>
      ...
      <div className="mx-auto max-w-screen-lg px-4 md:px-8">
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          ...
          <div className="flex flex-col items-center justify-center sm:items-start md:py-24 lg:py-32">
            ...
            <h1 className="mb-2 text-center text-2xl font-bold text-gray-800 sm:text-left md:text-3xl"> Sorry, but you must be logged in to declare results</h1>

            <p className="mb-4 text-center text-gray-500 sm:text-left md:mb-8 md:text-lg">Please Login to to declare any results! If you believe this to be an error, check your route and try again.</p>
