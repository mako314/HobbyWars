    ...
    useEffect(() => {
      ...
      loggedInDisplay = (
        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl"> Need to make an edit? Do it here! </h2>

            <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg"> Improvement? Congrats! Mistake in Entering? Human!</p>
            </div>
            ...
            <div className="sm:col-span-2">
                ...
                <input type="text" name="expertise" value={formik.values.expertise} onChange={formik.handleChange} className="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" placeholder={formik.values.expertise}/>
            </div>

            <div className="flex items-center justify-between sm:col-span-2">

                {/* NEED TO CHANGE COLOR */}
                <button type="submit" className="inline-block rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Finish Editing</button>
            ...
            <div className="mx-auto max-w-screen-lg px-4 md:px-8">
              <div className="grid gap-8 sm:grid-cols-2">
                ...
                <div className="flex flex-col items-center justify-center sm:items-start md:py-24 lg:py-32">
                  ...
                  <p className="mb-4 text-center text-gray-500 sm:text-left md:mb-8 md:text-lg">You must either Login, or be affiliated with that User Hobby to edit it. If you believe this to be an error, check your route and try again.</p>
