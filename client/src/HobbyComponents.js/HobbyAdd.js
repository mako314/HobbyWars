          ...
          <div className="mx-auto max-w-screen-lg px-4 md:px-8">
            <div className="grid gap-8 sm:grid-cols-2">
              ...
              <div className="flex flex-col items-center justify-center sm:items-start md:py-24 lg:py-32">
                ...
                <h1 className="mb-2 text-center text-2xl font-bold text-gray-800 sm:text-left md:text-3xl"> Sorry, but you must be logged in to add hobbies</h1>
    
                <p className="mb-4 text-center text-gray-500 sm:text-left md:mb-8 md:text-lg">Please login to add any hobbies to our available hobby list. If you believe this to be an error, check your route and try again.</p>
