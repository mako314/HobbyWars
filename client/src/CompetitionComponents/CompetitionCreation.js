        ...
        <div class="mx-auto max-w-screen-lg px-4 md:px-8">
          <div class="grid gap-8 sm:grid-cols-2">
            ...
            <div class="flex flex-col items-center justify-center sm:items-start md:py-24 lg:py-32">
              ...
              <h1 class="mb-2 text-center text-2xl font-bold text-gray-800 sm:text-left md:text-3xl"> Sorry, but you must be logged in to declare a War! Are you signed in?</h1>
  
              <p class="mb-4 text-center text-gray-500 sm:text-left md:mb-8 md:text-lg"> All Wars have Instigators! If you think this is a mistake and are logged in, check your route and try again.</p>
