...
function Footer({user, setUser}){
    ...
    return(
            ...
            <div className="container px-5 py-1 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <p className="text-sm text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2023 Hobby Wars — I love you all and will be rooting for you everyday!
                </p>
