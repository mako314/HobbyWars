      ...
      <div className="mx-auto max-w-screen-lg px-4 md:px-8">
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          ...
          <div className="flex flex-col items-center justify-center sm:items-start md:py-24 lg:py-32">
            ...
            <h1 className="mb-2 text-center text-2xl font-bold text-gray-800 sm:text-left md:text-3xl"> Sorry, but you do not seem to be the owner of this entry. Are you signed in?</h1>

            <p className="mb-4 text-center text-gray-500 sm:text-left md:mb-8 md:text-lg">You do not seem to be the owner of that entry. If you think this is a mistake, check your route and try again.</p>
